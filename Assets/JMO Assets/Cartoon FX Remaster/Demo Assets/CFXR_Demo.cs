...
namespace CartoonFX {
    public class CFXR_Demo : MonoBehaviour {
        ...
        public void ResetCam( ) {
            Camera.main.transform.SetPositionAndRotation( camInitialPosition, camInitialRotation );
        }
        ...
        private void Awake( ) {
            ...
            for ( int i = 0; i < this.transform.childCount; i++ ) {
                GameObject effect = this.transform.GetChild( i ).gameObject;
                list.Add( effect );

                if ( effect.TryGetComponent<CFXR_Effect>( out CFXR_Effect cfxrEffect ) ) cfxrEffect.clearBehavior = CFXR_Effect.ClearBehavior.Disable;
            }
        ...
        private void Update( ) {
            ...
            if ( scroll != 0f ) {
                Camera.main.transform.Translate( ( scroll < 0f ? -1f : 1f ) * zoomFactor * Vector3.forward, Space.Self );
            }
        }
